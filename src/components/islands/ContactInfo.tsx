      ...
      <div className="p-6 text-center border-2 border-primary-200 dark:border-primary-800 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
        ...
        <div className="flex justify-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-12 h-12 sm:w-10 sm:h-10 bg-black hover:bg-gray-900 text-white rounded-lg flex items-center justify-center transition-colors duration-200 focus-ring"
