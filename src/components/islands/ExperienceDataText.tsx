import { currentLanguage, t } from '@/stores/language';

interface ExperienceDataTextProps {
  experiences: any[];
}

export default function ExperienceDataText({
  experiences,
}: ExperienceDataTextProps) {
      ...
      {experiences.map((experience, index) => (
        ...
        >
          ...
          >
            ...
            {/* Card Content */}
            <div className="relative p-6 sm:p-8 md:p-10 min-h-[400px]">
              {/* Date and Duration */}
              <div className="mb-6">
                <div className="flex flex-col gap-3 mb-3">
                  <div className="text-primary-700 dark:text-primary-300 font-semibold text-base sm:text-lg">
                    ...
                    {experience.endDate
                      ...
                      : t.value.experience.present}
                  </div>
                  <div
                    className={`inline-flex items-center px-3 py-1.5 text-xs sm:text-sm font-semibold rounded-full self-start ${
                      experience.endDate
              ...
              {/* Description */}
              <p className="text-left text-gray-700 dark:text-gray-300 mb-8 text-base sm:text-lg leading-relaxed">
                {t.value.experience.jobs[
                  experience.id as keyof typeof t.value.experience.jobs
              ...
              <div className="mb-8">
                <h5 className="font-bold text-gray-900 dark:text-white mb-4 text-base sm:text-lg flex items-center">
                  <svg
                    className="w-5 h-5 mr-2 text-primary-600 dark:text-primary-400 flex-shrink-0"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
              ...
              {experience.achievements &&
                experience.achievements.length > 0 && (
                  <div>
                    <h5 className="font-bold text-gray-900 dark:text-white mb-4 text-base sm:text-lg flex items-center">
                      <svg
                        className="w-5 h-5 mr-2 text-green-600 dark:text-green-400 flex-shrink-0"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
                    ...
                    <ul className="space-y-3">
                      {(
                        ...
                        >
                          ...
                          <span className="text-left text-gray-700 dark:text-gray-300 text-sm sm:text-base leading-relaxed flex-1">
                            {achievement}
                          </span>
                        </li>
                      ))}
